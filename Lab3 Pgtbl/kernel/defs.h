...
int             kmappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm);
...
int             uvmcopy2kvm(pagetable_t, pagetable_t, uint64, uint64);
